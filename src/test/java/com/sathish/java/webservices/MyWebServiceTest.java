 ...
 */
package com.sathish.java.webservices;
...
public class MyWebServiceTest {
    ...
    public static void beforeClass() {
        marmotta = new JettyMarmotta("/com.sathish.java-test", 9090, MyWebService.class);

        RestAssured.baseURI = "http://localhost";
        RestAssured.port = 9090;
        RestAssured.basePath = "/com.sathish.java-test";
